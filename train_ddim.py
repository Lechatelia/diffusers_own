...
class TrainingConfig:
    ...
    output_dir = 'ddim-butterflies-128_exp2'  # the model namy locally and on the HF Hub
...
#     axs[i].imshow(image)
#     axs[i].set_axis_off()
# fig.savefig("butterflies.png", bbox_inches="tight")
...
#     axs[i].set_axis_off()
# # save the figure
# fig.savefig("butterflies-preprocessed.png", bbox_inches="tight")
...
# save image
Image.fromarray(((sample_image.permute(0, 2, 3, 1) + 1.0) * 127.5).type(torch.uint8).numpy()[0]).save("butterfly_noise.png")
